<?php
    ...
    if(isset($_POST['apply'])){
        ...
        $fi_id = $fi_row['Add_By'];
        $fn_query = "SELECT Name FROM userss WHERE Id = '".$fi_id."';";
        ...
        <center>
            <div class="adde">
                <form action="leaveform.php" method="POST">
                    ...
                    <lable class="lab_po">Reason :</lable>
                    <textarea name="leave_resaon" name="leavereason" class="add_emp_f" cols="10" rows="3"></textarea>
                    ...
                    <input type="submit" name="apply" class="btn1" value="Apply">
                </form>
            </div>
        </center>
    </body>
