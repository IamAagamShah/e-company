...
<html lang="en">
    ...
    <body style="background-color: #EEEEEE;">
        ...
        <div class="module1">
            ...
            <li class="modany1" style="font-weight : bolder; color : blue; border-bottom : 1px solid blue">Task Details</li>
            <a href="mytasksub.php?id=<?php echo $row['t_id'] ?>"><li class="modany1">Submit Report</li></a>
            <a href="mytasksubdreport.php?id=<?php echo $row['t_id'] ?>"><li class="modany1">Submited Report</li></a>
        </div>
        <div class="ghar">
            <center>
                <table class="csgo">
