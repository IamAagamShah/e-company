...
<html lang="en">
    ...
    <body style="background-color: #EEEEEE;">
        ...
        <div class="module1">
            <li class="modany1" style="font-weight : bolder; color : blue; border-bottom : 1px solid blue">Assigned to Employee</li>
            <a href="myhistorytask.php"><li class="modany1">Assigned by CEO</li></a>
        </div>
        <div class="ghar">
            <center>
                <table class="csgo">
