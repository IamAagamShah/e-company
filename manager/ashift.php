                        ...
                        while($row = mysqli_fetch_array($q_run)){
                            echo  
                                '<tr class="jinda">
                                    ...
                                    <td class="csgohd1"><a href="shiftdelete.php?id='.$row['s_id'].'" class="jaha">Delet</a></td>
                                </tr>';
                            $i=$i+1;
                        } 
                    ?>
