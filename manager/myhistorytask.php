...
<html lang="en">
    ...
    <div class="fpilore">
        ...
        <div class="module1">
            <a href="historytask.php"><li class="modany1">Assigned to Employee</li></a>
            <li class="modany1" style="font-weight : bolder; color : blue; border-bottom : 1px solid blue">Assigned by CEO</li>
        </div>
        <div class="ghar">
            <center>
                <table class="csgo">
                    ...
                    <?php
                        $s_query = "SELECT * FROM historytab WHERE h_assigntoid = '".$abcd."';";
                        ...
                        while($row = mysqli_fetch_array($q_run)){
                            ...
                            '<tr class="jinda">
                                ...
                                <td class="csgohd1"><a href="myviewhistory.php?id='.$row['h_taskid'].'" class="jaha">View</a></td>
                            </tr>';
                            $i=$i+1;
                        } 
                    ?>
