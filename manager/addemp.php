...
<html lang="en">
    ...
    <body style="background-color: #EEEEEE;">
        ...
        <div class="module1">
            <li class="modany1" style="font-weight : bolder; color : blue; border-bottom : 1px solid blue">Add Employee</li>
        </div>
        <center>
            <div class="adde">
                <form action="addemp.php" method="POST" enctype="multipart/form-data">
                    ...
                    <label class="lab_po">Employee Name :</label>
                    <input type="text" name="empname" class="add_emp_f" required autocomplete="off"><br>

                    <label class="lab_po">Employee email-id :</label>
                    ...
                    <lable class="lab_po">Employee Address :</lable>
                    <input type="text" name="empaddress" class="add_emp_f" required autocomplete="off"><br>

                    <lable class="lab_po">Employee contact-number :</lable>
                    ...
                    <select name="empsubpostselect" class="add_emp_f">
                        <option value="Computer Engeener">Computer Engeener</option>
                    </select><br>
