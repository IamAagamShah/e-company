...
<html lang="en">
    ...
    <body style="background-color: #EEEEEE;">
        ...
        <div class="module">
            ...
            <li class="modany" style="background-color: #EEEEEE; color: #3423CA;">My Task</li>
            <a href="task.php"><li class="modany">Assign</li></a>
            <a href="historytask.php"><li class="modany">History</li></a>
        </div>
        <div class="module1">
            <li class="modany1" style="font-weight : bolder; color : blue; border-bottom : 1px solid blue">Your Task</li>
        </div>
        <div class="ghar">
            <center>
                <table class="csgo">
                    <tr class="jinda">
                        ...
                        <td class="csgohd">Report</td>
                    </tr>
                    <?php
                        $s_query = "SELECT * FROM TaskMana WHERE t_empid = '".$abcd."';";
                        ...
                        while($row = mysqli_fetch_array($q_run)){
                            echo  
                                '<tr class="jinda">
                                    ...
                                    <td class="csgohd1"><a href="mytaskview.php?id='.$row['t_id'].'" class="jaha">Submit</a></td>
                                </tr>';
                            $i=$i+1;
                        } 
                    ?>
