...
<html lang="en">
    ...
    <div class="fpilore">
        ...
        <div class="module1">
            <a href="myhistorytask.php"><li class="modany1" style="font-size : 30px;"><span>&#10094;</span></li></a>
            <li class="modany1" style="font-weight : bolder; color : blue; border-bottom : 1px solid blue">Task Detail Assigned by CEO</li>
        </div>
        <div class="ghar">
            <center>
                <table class="csgo">
