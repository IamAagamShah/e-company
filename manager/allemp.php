...
<html lang="en">
    ...
    <body style="background-color: #EEEEEE;">
        ...
        <div class="module">
            ...
            <li class="modany" style="background-color: #EEEEEE; color: #3423CA;">Employees</li>
            <a href="empattendance.php"><li class="modany">Attendance</li></a>
        </div>
        <div class="module1">
            <li class="modany1" style="font-weight : bolder; color : blue; border-bottom : 1px solid blue">All Employees</li>
        </div>
        <div class="ghar">
            <center>
                <table class="csgo">
                        ...
                        while($row = mysqli_fetch_array($q_run)){
                            echo  
                                '<tr class="jinda">
                                    ...
                                    <td class="csgohd1"><a href="allempview.php?id='.$row['Id'].'" class="jaha">View</a></td>
                                    <td class="csgohd1"><a href="deleteemployee.php?id='.$row['Id'].'" class="jaha">Delete</a></td>
                                </tr>';
                            $i=$i+1;
                        } 
                    ?>
