<?php
    include_once '../db.php';
    include '../forset.php';
    $s_query = "SELECT * FROM historytab WHERE h_taskid = '".$_GET['id']."';";
    $q_run = mysqli_query($conn, $s_query);
    $row = mysqli_fetch_array($q_run);
    $taskname = $row['h_taskname'];
    $taskdesc = $row['h_taskdesc'];
    $assignby = $row['h_assignbyname'];
    $assignto = $row['h_assigntoname'];
    $dateassign = $row['h_assigndate'];
    $timeassign = $row['h_assigntime'];
    $comdate = $row['h_comdate'];
    $comtime = $row['h_comtime'];
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <div class="fpilore">
        ...
        <div class="module">
            ...
            <a href="mytask.php"><li class="modany">My Task</li></a>
            <a href="task.php"><li class="modany">Assign</li></a>
            <a href="historytask.php"><li class="modany" style="background-color: #EEEEEE; color: #3423CA;">History</li></a>
        </div>
        <div class="module1">
            <a href="historytask.php"><li class="modany1" style="font-size : 30px;"><span>&#10094;</span></li></a>
            <li class="modany1" style="font-weight : bolder; color : blue; border-bottom : 1px solid blue">Task Detail Assigned by You</li>
        </div>
        <div class="ghar">
            <center>
                <table class="csgo">
                    ...
                    <tr class="jinda">
                        ...
                        <td class="csgohd1"><?php echo $comdate ?></td>
                    </tr>
                    <tr class="jinda">
                        <td class="csgohd">Completed Time</td>
                        <td class="csgohd1"><?php echo $comtime ?></td>
                    </tr>
                </table>
            </center>
        </div>  
