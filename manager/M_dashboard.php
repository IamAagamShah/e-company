        ...
        <div class="yado">
            ...
            <div class="masti">
                <center>
                    ...
                    <br>
                    <a href="updatemanager.php" style=" margin-right : 110px; font-size : 20px; padding : 5px; background-color : #3423CA; border : none; color: white; font-weight : bolder;">Update</a>
                </center>
            </div>
        </div>
    </body>
