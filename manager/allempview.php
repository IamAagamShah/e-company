...
<html lang="en">
    ...
    <body style="background-color: #EEEEEE;">
        ...
        <div class="module1">
            <a href="allemp.php"><li class="modany1" style="font-size : 30px;"><span>&#10094;</span></li></a>
            <li class="modany1" style="font-weight : bolder; color : blue; border-bottom : 1px solid blue">Employee's Detail</li>
        </div>
        <div class="ghar">
            <center>
                <table class="csgo">
