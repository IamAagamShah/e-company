...
<html lang="en">
    ...
    <div class="fpilore">
        ...
        <a href="addman.php"><li class="modany">Add</li></a>
            ...
            <li class="modany" style="background-color: #EEEEEE; color: #3423CA;">Manager Attendance</li>
        </div>
        <div class="module1">
            <li class="modany1" style="font-weight : bolder; color : blue; border-bottom : 1px solid blue">Select Manager</li>
        </div>
        <center>
            <div class="adde2">
                <form action="manattendance.php" method="POST">
            ...
            <div class="atten">
                ...
                <?php 
                    try {
                        ...
                        //to avoid error of build_calendar function
                    }
                ?>
            </div>
        </center>
