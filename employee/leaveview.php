...
<html lang="en">
    ...
    <body style="background-color: #EEEEEE;">
        ...
        <div class="module">
            ...
            <li class="modany" style="background-color: #EEEEEE; color: #3423CA;">My Leave</li>
            <a href="myattend.php"><li class="modany">Attendance</li></a>
        </div>
        <div class="module1">
            <li class="modany1" style="font-weight : bolder; color : blue; border-bottom : 1px solid blue">Leave Detail</li>
        </div>
        <div class="ghar">
            <center>
                <table class="csgo">
