            ...
            <div class="masti">
                <center>
                    <table class="tdtail">
                        ...
                        <tr class="tdtailrow">
                            <td class="tdetail1">Contect-Number</td>
                            <td class="tdetail1">:</td>
                            <td class="tdetail2"><?php echo $_SESSION['dash_Contact'] ?></td>
                        </tr>
                        <tr class="tdtailrow" style="background-color: #EEEEEE;">
                            <td class="tdetail1">Post</td>
                            <td class="tdetail1">:</td>
                            <td class="tdetail2"><?php echo $_SESSION['dash_Post'] ?></td>
                        </tr>
                        <tr class="tdtailrow">
                            <td class="tdetail1">Sub-Post</td>
                            <td class="tdetail1">:</td>
                            <td class="tdetail2"><?php echo $_SESSION['dash_SubPost'] ?></td>
                        </tr>
                    </table>
                    <br>
                    <a href="updateemployee.php" style=" margin-right : 110px; font-size : 20px; padding : 5px; background-color : #3423CA; border : none; color: white; font-weight : bolder;">Update</a>
                </center>
            </div>
        </div>
    </body>
